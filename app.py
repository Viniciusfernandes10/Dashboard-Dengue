...
with col_a:
    ...
    st.plotly_chart(bar_chart(list(fe.values), list(fe.index), orientation='h'), width='stretch')
...
with col_b:
    ...
    st.plotly_chart(bar_chart(values, labels, orientation='h', highlight_last_muted=True), width='stretch')
...
st.plotly_chart(bar_chart(list(classi.values), list(classi.index), orientation='h'), width='stretch')
